...
<head>
    ...
    <title>Edit Interest - MyCareer Admin</title>
    ...
    <div class="admin-container">
        ...
        <main class="admin-main">
            <header class="admin-header">
                <div class="header-title"><h1>Edit Interest</h1></div>
            ...
            <section class="admin-content">
                ...
                <div class="form-card">
                    <form method="post" action="/admin/interests/edit/<?php echo htmlspecialchars($interest['id'], ENT_QUOTES); ?>">
                        <div class="form-group">
                            <label>Name</label>
                            <input type="text" name="name" value="<?php echo htmlspecialchars($interest['name'], ENT_QUOTES); ?>" required>
                        </div>
